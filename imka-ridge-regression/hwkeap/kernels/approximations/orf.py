...
class OrthogonalRandomFeatures(BaseApproximator):
    """Orthogonal Random Features (ORF) for kernel approximation.
    ...
    def __init__(self, kernel, s, d, device):
        ...
        W_ = get_orthogonal_matrix(self.s, self.d, device, fast=False)
        # Kernel-depend initializations.
